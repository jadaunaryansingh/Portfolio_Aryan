...
const tickerItems = [
  "★ 🏆 EXTRA DISPATCH: ARYAN SINGH JADAUN & TEAM CROWNED 1ST PRIZE WINNERS AT SMART INDIA HACKATHON (SIH) INTERNAL 2026 — SOFTWARE CATEGORY (₹10,000 CASH AWARD)!",
  "★ ARYAN SINGH JADAUN — AIML ENGINEER & FULL-STACK DEVELOPER FROM AGRA, INDIA",
  "★ GLA UNIVERSITY AIML UNDERGRAD SHIPS 40+ LIVE AI & SYSTEM PRODUCTS IN 2026",
  "★ KRUGERX BROWSER: AI-POWERED MULTI-PLATFORM BROWSER & ENGINE IN ACTIVE DEVELOPMENT [WIP]",
  "★ ENTERPRISE PROJECT MANAGEMENT SYSTEM: ARYAN LEADS BACKEND DEVELOPMENT & ARCHITECTURE [WIP]",
