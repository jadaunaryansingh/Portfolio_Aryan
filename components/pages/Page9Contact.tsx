...
const contactItems = [
  ...
  },
  {
    ...
    description: "Browse 40+ deployed projects, live AI systems, and open-source work.",
    icon: "◈",
...
const fakeAds = [
  ...
  },
  {
    ...
    body: "Fintech platform requires React + Python + Firebase expert. 40+ live projects preferred. GLA University AIML candidates strongly encouraged to apply.",
    cta: "CONTACT US",
  },
  {
          ...
          <div className="col-span-12 md:col-span-8">
            ...
            >
              ...
              <p className="body-text text-sm mb-4" style={{ color: "#d4bc8a" }}>
                ...
                alumnus, and builder of 40+ live AI & system products — is actively seeking internships and
