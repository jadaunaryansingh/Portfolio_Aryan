...
const projects = [
  ...
  {
    id: "legally-app",
    label: "WEB TECH / LEGAL SERVICES",
    headline: "Legally Web Platform — Interactive AI Legal Workspace",
    subhead: "Web-based legal assistant, document builder, and attorney matching portal",
    body: "Legally Web Platform simplifies complex legal jargon, automates document workflows, and connects users with local legal services. Features a responsive web interface with real-time Firebase cloud synchronization.",
    stack: ["React", "Web Platform", "Firebase", "Legal Tech", "APIs", "UI/UX"],
  ...
  {
    id: "fullstack-ai",
    label: "Live NewsPaper Portfolio",
  ...
  {
    id: "legally-apk",
    label: "MOBILE TECH / FLUTTER APP",
    headline: "Legally Mobile App — Flutter Android APK Release",
    subhead: "Cross-platform Flutter & Dart mobile application for legal assistance",
    body: "The native Android mobile package (APK) of Legally, built with Flutter & Dart. Provides on-the-go legal assistance, mobile document generation, and real-time Firebase mobile backend integration.",
    stack: ["Flutter", "Dart", "Android APK", "Mobile App", "Firebase"],
    live: "https://github.com/jadaunaryansingh/Legally_Flutter_App/releases/tag/v1.0.0",
    size: "medium",
    column: "col-span-12 md:col-span-6",
    emoji: "📱",
  },
