...
const knowledgeBase: Record<string, string> = {
  ...
  "aryan": "Aryan Singh Jadaun is an AIML undergraduate at GLA University (graduating 2028), a LinuxWorld Informatics alumnus, and the builder of 40+ live AI products and digital systems. He is from Agra, UP — tech-obsessed since childhood. Engineer. Builder. Dreamer. Rider.",
  ...
  "projects": "Aryan has built 40+ unique projects: 🌐 KrugerX Browser (AI-powered browser ecosystem [WIP]), 📋 Enterprise Project Management System (Backend Lead [WIP]), 🚖 CAB-I-NET (Cab aggregator), 🗺️ Travel Itinerary AI, 🎙️ Voice Authentication, 🔓 Jailbreak Web App, 📈 Enterprise Predictor, 💸 PrimeTrade AI, 👕 Clothing Recommendation, 🔬 Cancer Research, 🧠 Brain Stroke Detection, 🏥 CareSync HMS, 📰 Living Newspaper Portfolio, 🤖 AI Agent Architecture, ⚡ Groq RAG Model, 📝 QuizMaker AI, ⚙️ Zorvyn Backend, ⚖️ Legally Web Platform, 💬 Sentiment Analysis, 💼 Full Stack AI Collections, 📱 Legally Mobile App (Flutter Android APK), and 🩺 Jaipur Hospital Booking Chatbot, and many more.",
  ...
  "github": "Aryan's GitHub: github.com/jadaunaryansingh — Find KrugerX Browser [WIP], Enterprise PMS [WIP], Zorvyn Backend, CareSync, CAB-I-NET, Voice Auth, and 34+ other projects.",
