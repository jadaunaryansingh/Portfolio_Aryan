        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {contactItems.map((item, index) => (
            <a
              ...
              className="group block p-8 rounded-3xl bg-gray-900/90 shadow-2xl hover:shadow-4xl transition-all duration-700 hover:scale-110 hover:-translate-y-6 hover:rotate-2 relative overflow-hidden"
              data-aos="fade-up"
              data-aos-delay={index * 100}
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${item.color}/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-60 transition-opacity duration-300">
                <Sparkles className="w-4 h-4 text-yellow-400 animate-spin" />
              </div>
              <div className="text-center">
                <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br ${item.color} text-white mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 shadow-xl relative`}>
                ...
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text group-hover:from-blue-400 group-hover:to-purple-400 transition-all duration-500">
                  {item.label}
                </h3>
                <p className="text-gray-300 text-sm group-hover:scale-105 transition-transform duration-300">
                  {item.value}
                </p>
              </div>
            </a>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {contactItems.map((item, index) => (
            <a
              ...
              data-aos-delay={index * 100}
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${item.color}/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none`}></div>
              <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-60 transition-opacity duration-300">
                <Sparkles className="w-4 h-4 text-yellow-400 animate-spin" />
              </div>
              <div className="text-center">
