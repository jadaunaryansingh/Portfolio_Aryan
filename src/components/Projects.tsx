...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 px-4 bg-gray-50/50 dark:bg-gray-900/50 relative overflow-hidden">
      {/* Animated background */}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="project-card group relative overflow-hidden rounded-3xl bg-white dark:bg-gray-800 shadow-2xl hover:shadow-4xl transition-all duration-700 hover:scale-110 hover:-translate-y-8 hover:rotate-1 animate-float-card"
              data-aos="fade-up"
            ...
            >
              ...
              <div className="relative p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text group-hover:from-blue-500 group-hover:to-purple-500 transition-all duration-500 animate-text-glow">
                    {project.title}
                  </h3>
                </div>

                <p className="text-gray-600 dark:text-gray-300 mb-6 text-lg group-hover:scale-105 transition-transform duration-300 animate-fade-in-up">
                  {project.description}
                </p>

                <ul className="space-y-2 mb-8">
                  {project.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center text-gray-700 dark:text-gray-300 hover:scale-105 transition-transform duration-300 animate-slide-in-left" style={{animationDelay: `${featureIndex * 0.1}s`}}>
