      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-fade-in-up" data-aos="fade-up">
          <h2 className="text-5xl font-bold animate-gradient-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent hover:scale-105 transition-transform duration-300">
            <span className="inline mr-2 text-4xl">🚀</span>
            🧱 40+ Live Projects
            <span className="inline ml-2 text-3xl">✨</span>
          </h2>
            ...
            >
              ...
              <div className="relative p-8">
                <div className="flex items-center mb-6">
                  <div className={`p-4 rounded-2xl bg-gradient-to-br ${project.gradient} text-white mr-4 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 animate-float shadow-lg text-3xl`}>
                    {project.emoji}
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  >
                    ...
                    <span className="mr-2 animate-bounce relative z-10">🔗</span>
