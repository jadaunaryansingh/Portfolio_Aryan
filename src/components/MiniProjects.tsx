      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-in-up" data-aos="fade-up">
          <h2 className="text-4xl font-bold bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-4 animate-gradient-text">
            🛠️ 40+ Mini Projects &amp; Experiments
          </h2>
          ...
          {miniProjects.map((project, index) => (
            ...
            >
              ...
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 text-white mb-5 shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 animate-float text-3xl">
                  {project.emoji}
                </div>
